...
public class PictureActivityAdapter extends BaseAdapter {
	...
	public PictureActivityAdapter(Context context,
	...
	public View getView(int arg0, View convertView, ViewGroup arg2) {
		if (convertView == null) {
			convertView = inflater
					.inflate(R.layout.picturevideo_listitem, null);
	...
	public void addBmpAndSum(Bitmap bmp, int sum) {
