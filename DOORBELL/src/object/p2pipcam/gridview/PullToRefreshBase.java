...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_mode1)) {
			mode = a.getInteger(R.styleable.PullToRefresh_mode1, MODE_PULL_DOWN_TO_REFRESH);
		}
		...
		if (a.hasValue(R.styleable.PullToRefresh_headerBackground1)) {
			this.setBackgroundResource(a.getResourceId(R.styleable.PullToRefresh_headerBackground1, Color.WHITE));
		}
