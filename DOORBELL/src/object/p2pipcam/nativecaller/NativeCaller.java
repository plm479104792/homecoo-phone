...
public class NativeCaller {
	...
	public native static int CheckHandle(String did);
	...
	public native static int StartPPPPLivestream(String did, int streamid,String fileName);
	...
	public native static int SetAPParam(String did, String ssid, String pwd);
	...
	public native static int OpenAviFileName(String did, String filename,
			String forcc, int height, int width, int framerate);
