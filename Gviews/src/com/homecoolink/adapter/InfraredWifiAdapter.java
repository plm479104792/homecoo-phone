...
//        } 
	...
	public int getCount() {
		...
		if (!mWifiManager.isWifiEnabled())  
        {  
			this.mPromptView.setVisibility(View.VISIBLE);
			return 0;
        } 
		...
		if(datas==null||datas.size()==0){
			...
			this.mPromptView.setVisibility(View.GONE);
			return datas.size();
		}
	...
	public View getView(int position, View arg1, ViewGroup arg2) {
		...
		if(type==0){
			wifi_type.setVisibility(View.GONE);
		}else{
			wifi_type.setVisibility(View.VISIBLE);
		}
