...
public class SharedPreferencesManager {
	...
	public static final String ALARM_RECORD_INDEX="alarm_record_index";
	...
	public void putAlarmRecordIndex(Context context,int index){
		SharedPreferences sf = context.getSharedPreferences(SP_FILE_GWELL, Context.MODE_PRIVATE);
		Editor editor = sf.edit();
		editor.putInt(NpcCommon.mThreeNum+ALARM_RECORD_INDEX,index);
		editor.commit();
	}
	public int getAlarmRecordIndex(Context context){
		SharedPreferences sf = context.getSharedPreferences(SP_FILE_GWELL, Context.MODE_PRIVATE); 
		return sf.getInt(NpcCommon.mThreeNum+ALARM_RECORD_INDEX, -1);
	}
}	
