...
public class Constants {
	...
	public static final String PACKAGE_NAME = "com.homecoolink.";
	...
	public static class P2P{
		...
		public static final String ACK_RET_GET_ALAEM_RECORD=PACKAGE_NAME+"ACK_RET_GET_ALAEM_RECORD";
		public static final String RET_GET_ALARM_RECORD=PACKAGE_NAME+"RET_GET_ALARM_RECORD";
	}
...
// add 
	...
	public static class ActivityInfo{
		...
		public static final int ACTIVITY_ALARMRECORDFROMDEVICEACTIVITY=54;
		public static final int ACTIVITY_ALARMVIDEO = 55;
		
		
		public static final int ACTIVITY_RADARADDFIRSTACTIVITY=56;
		public static final int ACTIVITY_RARDARADDACTIVITY=57;
