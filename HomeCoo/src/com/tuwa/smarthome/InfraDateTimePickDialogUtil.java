...
import com.tuwa.smarthome.InfraDateTimePickDialogUtil.SwitchsAdapter.Holder;
...
public class InfraDateTimePickDialogUtil implements OnDateChangedListener,OnTimeChangedListener,
	 ...
	 */
	public InfraDateTimePickDialogUtil(Activity activity, String initDateTime,Device device,int scheduleType) {
	...
	public AlertDialog dateTimePicKDialog(final Handler handler ) {
		...
		LinearLayout dateTimeLayout = (LinearLayout) activity
				.getLayoutInflater().inflate(R.layout.layout_time_picker_infra, null);
		
		TimePicker tp=new TimePicker(activity);  //屏蔽TimePicker时间点击事件改变异常
		dateTimeLayout.addView(tp);
		
		viewPager=(ViewPager) dateTimeLayout.findViewById(R.id.vp_timer_vpager1);
		pageViews = new ArrayList<View>();
		timerViews = new View[2];
		timerViews[0]= activity.getLayoutInflater().inflate(R.layout.item_single_timer_infra, null);
		...
		rg_time = (RadioGroup) dateTimeLayout.findViewById(R.id.rg_timer1);
...
//                	   String strPacket=WebPacketUtil.converTheme2PacketStr(theme);
    ...
    private void initScheduleSingleView() {
		...
		timePickerSingle = (TimePicker) timerViews[0].findViewById(R.id.time_picker_single1);
