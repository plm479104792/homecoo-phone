...
public  class  NetValue {
	//============服务器网络参数=================
//	 public static final String SERVER_URL="http://192.168.1.104:8080/smarthome";
...
//	 public static final String SERVER_IP="192.168.0.108";
	 ...
	 public static final String GATEWAY_UNBIND_URL=SERVER_URL+"/appUnbindGatewayNo";  //解绑用户和网关绑定
	...
	//===========【device】==========/
	 ...
	 public static final String SCHEDULE_UPDATE_URL=SERVER_URL+"/appUpdateSchedule";//删除定时
	 ...
	 public static final String MUSIC_VOLUME_GET=SERVER_URL+"/appGetVolume";  //APP获取七寸屏当前的音量
	...
	//============内网网络参数=================
	 public static String LOCAL_IP ="192.168.1.108";  //本地主机IP
	...
	//============内外网标志=================
	public static  int netFlag=0;       //网络状态
	...
	public static Short DATA_GET_SCENE=14;          //手机向网关请求情景设置信息
	...
	public static Short ACK_FINISH_SCENE=70;        //网关完成保存情景应答
	...
	public static Short DATA_SET_AP= 106;               //设置网关wifi
	public static Short DATA_SET_STA= 107;               //网关无线桥接路由
