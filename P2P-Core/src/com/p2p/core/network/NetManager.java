...
//	 private static final String SERVER1 = "http://cloudlinks.cn/";
//	 private static final String SERVER2 = "http://cloudlinks.cn/";
//	 private static final String SERVER3 = "http://cloudlinks.cn/";
//	 private static final String SERVER4 = "http://cloudlinks.cn/";
...
//	private static final String SERVER4 = "http://192.168.1.222/";
	...
	private static String ALARM_MSSAGE_URL = CURRENT_SERVER
			+ "Alarm/AlarmRecordEx.ashx";
    ...
    public static final int GET_ALARM_RECORD_NO_PERMISION=35;
	...
	private static void updateUrl(String server) {
		...
		SEARCH_BIND_DEVICE_ACCOUNT = server
				+ "Account/Bind/SearchBindAccountEx.ashx";
		...
		ALARM_MSSAGE_URL = server+ "Alarm/AlarmRecordEx.ashx";
	...
	public JSONObject getBindDeviceAccountList(String phone, String sessionId,
			String deviceId) {
		JSONObject jObject = null;
	...
	public JSONObject getAlarmRecordList(String contactId, String sessionId,String SenderList,
			String index, int pageSize, int option,int CheckLevelType, String VKey) {
		JSONObject jObject = null;
		...
		params.add(new BasicNameValuePair("UserID", String.valueOf(Integer
				.parseInt(contactId) | 0x80000000)));
		params.add(new BasicNameValuePair("SessionID", sessionId));
		params.add(new BasicNameValuePair("SenderList", SenderList));
		...
		params.add(new BasicNameValuePair("CheckLevelType", String
				.valueOf(CheckLevelType)));
	...
	public int setBindDeviceAccount(String phone, String sessionId,
			String deviceId, String account, String flag, String name) {
		int result = UNKNOWN_ERROR;
	...
	public int modifyNikeName(String phone, String sessionId, String deviceId,
			String name) {
		int result = UNKNOWN_ERROR;
	...
	public int deleteBindDeviceAccount(String phone, String sessionId,
			String deviceId, String account) {
		int result = UNKNOWN_ERROR;
	...
	public JSONObject login(String username, String password) {
		if (MyUtils.isNumeric(username)) {
			username = String
					.valueOf((Integer.parseInt(username) | 0x80000000));
		}
		JSONObject jObject = null;
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		MD5 md = new MD5();
	...
	public JSONObject getAlarmMessage(String username, String sessionId,
			String SenderList, int pageSize, int option,
			int CheckLevelType, String VKey) {
		JSONObject jObject = null;
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("UserID", String.valueOf(Integer
				.parseInt(username) | 0x80000000)));
		params.add(new BasicNameValuePair("SessionID", sessionId));
		params.add(new BasicNameValuePair("SenderList", SenderList));
		params.add(new BasicNameValuePair("pageSize", String.valueOf(pageSize)));
		params.add(new BasicNameValuePair("Option", String.valueOf(option)));
	...
	public JSONObject getNewAlarmMessage(String username, String sessionId,
			String SenderList,String index, int pageSize, int option,
			int CheckLevelType, String VKey) {
		JSONObject jObject = null;
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("UserID", String.valueOf(Integer
	...
	public JSONObject register(String VersionFlag, String Email,
			String CountryCode, String PhoneNO, String password,
			String rePassword, String VerifyCode, String IgnoreSafeWarning) {
		JSONObject jObject = null;
		MD5 md = new MD5();
		List<NameValuePair> params = new ArrayList<NameValuePair>();
	...
	public static GetDeviceListResult createGetDeviceListResult(
			JSONObject jObject) {
	...
	public static GetBindDeviceAccountResult createGetBindDeviceAccountResult(
			JSONObject jObject) {
	...
	public static GetAlarmRecordListResult createGetAlarmRecordListResult(
			JSONObject jObject) {
